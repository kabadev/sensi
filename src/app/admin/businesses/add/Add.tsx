...
// 			// }
// 			try {
// 				const response = await axios.post("/api/businesses", dataToSend);

// 				setFormData(initialFormData);
// 				setIsLoading(false);
// 				toast.success("New business Created successfully");
...
// 			<h1 className="text-lg font-[600]">Add new Business</h1>
// 			<div className="my-6">
	...
	const handleFormSubmit = async (e: React.FormEvent) => {
		...
		if (validateForm()) {
			...
			if (fileImage) {
				...
				try {
					await axios.post("/api/businesses", dataToSend);
